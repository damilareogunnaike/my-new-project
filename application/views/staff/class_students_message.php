            ...
            <div class="tab-pane <?=(!isset($active_tab)) ? "active" : '';?>" id="subjects">
                <div class="panel panel-default">
                     <div class="panel-heading ">
                        <h3 class="panel-title text-center text-uppercase">Send Message | <?=$class_name;?></h3>
                    </div>
                    <?=form_open('staff/send_message')?>
                    <input type="hidden" value="class_students_message" name="target">
                    ...
                    <div class="panel-footer">
                        ...
                        <div class="col-md-8 col-md-offset-2 text-right">
                            <?php 
                            if(isset($class_students) && sizeof($class_students) > 0) { ?>
