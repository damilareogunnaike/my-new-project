    ...
    <div class="col-md-12">
        <ul class="nav nav-tabs">
            <li class="<?=(!isset($active_tab)) ? "active" : '';?>">
                <?=anchor('#add_class','Add Class',array('data-toggle'=>"tab"));?>
            </li>
        ...
        <div class="tab-content">
            <div class="tab-pane <?=(!isset($active_tab)) ? "active" : '';?>" id="add_class">
                <div class="panel panel-default">
                     <div class="panel-heading ">
                         <h3 class="panel-title text-center text-uppercase">Add New Class</h3>
                    </div>
            ...
            <div class="tab-pane <?=(isset($active_tab) && $active_tab == "view_class") ? "active" : "";?>" id="view_class">
                <div class="panel panel-default">
                    <div class="panel-heading">
                        <h3 class="panel-title text-center text-uppercase">All Classes</h3>
                    </div>
                    <div class="panel-body">
                        <div class="row">
                            <div class="col-md-8 col-md-offset-2">
                            ...
                            <tbody>
                                ...
                                <tr>
                                    ...
                                    <td><?=anchor('school_setup/view_class_students/'.$class['class_id'],'View Students');?></td>
                                    <td>
