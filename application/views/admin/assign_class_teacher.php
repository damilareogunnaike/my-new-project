    ...
    <div class="col-md-12">
        <ul class="nav nav-tabs">
            <li class="<?=(!isset($active_tab))? "active" : '';?>">
                <?=anchor('#assign_teacher','Assign Class Teacher',array('data-toggle'=>'tab'));?>
            </li>
            <li class="<?=(isset($active_tab) && ($active_tab == "view_teacher"))? "active" : '';?>">
                <?=anchor('#view_teacher','View Class Teacher',array('data-toggle'=>'tab'));?>
            </li>
        </ul>
        <?=isset($msg) ? $msg : '';?>
                       ...
                       <?=form_open('admin/view_class_teacher')?>
                        ...
                        <div class="form-group">
                            ...
                            <div class="text-center">
                             <?=form_submit(array('class'=>'btn btn-primary','value'=>'View Class','name'=>'view_class'));?>
                            </div>
                        </div>
                         <div class="col-md-6">
                        <div class="form-group">
